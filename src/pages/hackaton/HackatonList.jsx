    ...
    >
      ...
      {hackatonsByCity.length === 0 ? null : (
        <div>
          ...
          <h6>
            ¡Encuentra los Hackathones que se celebran muy pronto en tu
            Comunidad Autónoma!
          </h6>
        </div>
      )}
                ...
                <Card>
                  ...
                  <Card.Body className="cardBody">
                    ...
                    <button className="buttonHackaton masInfo">
                      <Link
                        to={`/hackaton/details/${eachHackaton._id}`}
      ...
      {allHackatones.length === 0 ? (
        ...
        <div>
          ...
          <h4>
            En esta lista aparecen todos los Hackathones organizados en este
            país.
          </h4>
          <h6>
            Puedes conocer todos los detalles de estos en el boton de "Más
            información".
          </h6>
        </div>
      )}
